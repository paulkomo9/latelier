...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <meta name="description" content="L'Atelier Aqua Fitness offers expert-led aqua fitness classes that improve flexibility, burn calories, and support joint health. Join today for a fun, low-impact workout experience." />
