                ...
                <div class="col-md-6">
                    <div class="card p-4 shadow-sm">
                        ...
                        <form id="payment-form"
                            action="{{ route('checkout.process', ['type' => $type, 'id' => $item->id, 'lang' => app()->getLocale()]) }}"
                            method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input id="card-holder-name" type="text" class="form-control"
                                    value="{{ $cardholdername }}" required readonly>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="line1" type="text" class="form-control" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="postal_code" type="text" class="form-control" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Country (2-letter code)</label>
                                <input id="country" type="text" class="form-control" placeholder="AE" required>
                            </div>
                            ...
                            <div style="text-align: center; margin-top: 15px;">
                                ...
                                <a href="https://stripe.com" target="_blank">
                                    <img src="{{ asset('images/stripe/Stripe_Logo_1.png') }}" alt="Stripe Logo"
                                        style="height: 40px;">
                                </a>
                    ...
                    <div class="card p-4 shadow-sm bg-light rounded">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2">
                                ...
                                @if ($item->tax_type === 'percentage')
                                    {{ $item->currency ?? 'AED' }}
                                    {{ number_format($item->total_amount - $item->amount, 2) }}
                                @else
