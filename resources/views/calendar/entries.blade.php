...
@section('content')
    ...
    <div class="container pt-4 pb-4">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">{{  __('Calendar Entries') }}</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{  __('FitBoard') }}</a></li>
                                    <li class="breadcrumb-item active">{{  __('Manage Calendar Entries') }}</li>
                                </ol>
                            </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="text-left mb-2">
                    <!--button type="button" class="btn btn-primary waves-effect waves-light {{ !$isAdmin && (!isset($permissions['add']) || !$permissions['add']) ? 'disabled' : '' }}" data-bs-toggle="modal" data-bs-target="#calendarentriesModal" id="createNewCalendarEntry">
                        <x-lucide-calendar-clock   class="font-size-16 align-middle me-2" style="width: 1.5em; height: 1.5em;"/>{{  __('Add New Calendar Entry') }}
                    </button-->    
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6">
                <div class="alert alert-success alert-dismissible fade show text-center" role="alert" id="notification-success" style="display:none;">
                    <i class="mdi mdi-check-all me-2"></i>
                        <span id="notification-success-message">Calendar entry added.</span> 
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <table id="datatable-calendar-entries" class="table table-bordered dt-responsive  nowrap w-100">
                                <thead>
                                    <tr>
                                        <th>{{  __('#') }}</th>
                                        <th>{{  __('Title') }}</th>
        ...
        <!-- Create Update Modal -->
            <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="calendarentriesModal" tabindex="-1" aria-labelledby="calendarentriesModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h4 class="modal-title text-white" id="modalCalendarEntriesHeading"></h4>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>

                        <div class="alert alert-danger print-error-msg" role="alert" id="calendar-entry-modal-warning" style="display:none">
                            <ul></ul>
                        </div>
                                
                        <!-- form starts here -->
                            <form id="calendarentryForm" name="calendarentryForm" class="form-horizontal">
                                <input type="hidden" name="appointment_id" id="appointment_id" class="form-control" value="">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 mb-3">
                                                        <div class="row">
                                                            ...
                                                            <!-- Slots Remaining -->
                                                                <div class="col-3">
                                                                    <label for="slots_remaining" class="form-label">{{ __('Availability') }}</label>
                                                                       <input type="number" id="slots_remaining" name="slots_remaining"
                                                                                                                class="form-control input-mask text-start"
                                                                                                                min="0" value="1" max="9" readonly>
                                ...
                                <div class="modal-footer bg-secondary-subtle">
                                    ...
                                    <button type="button" class="btn btn-primary" id="saveBtnCalendarEntry" value="create"> <x-elusive-plus class="text-success font-size-12" style="width: 0.8em; height: 0.8em;" /> 
                                        <span id="saveBtnCalendarEntryName">{{ __('Add Calendar Schedule') }}</span><i class="fa fa-spinner fa-spin font-size-20 align-middle me-2" style="display:none;"></i>
                                    </button>
                                </div>
                            </form>
                        <!-- form ends here -->
        ...
        <!-- Delete Calendar Entry Modal -->
            <div class="modal fade" id="deleteCalendarEntryModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="deleteCalendarEntryModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h5 class="modal-title text-white" id="deleteCalendarEntryModalTitle">Modal title</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        ...
                        <!--content-->
                            <div class="modal-body" id="deleteCalendarEntryModalContent">
                            </div>
                        <!--content ends here-->
                                            
                        <div class="modal-footer bg-secondary-subtle">
                            <!--form starts here-->
                                <form id="deleteCalendarEntryForm"  class="form-horizontal">
                                    <input type="hidden" name="del_appointment_id" id="del_appointment_id" class="form-control">
                                        <div class="mb-3"> 
                                            ...
                                            <button type="button" class="btn bg-danger text-white" id="deleteBtnCalendarEntry" value="delete"><x-uiw-delete class="text-white font-size-20 me-2" style="width: 1em; height: 1em;" /> 
                                                {{ __('Cancel Calendar Entry') }} 
        ...
        <!-- Delete Calendar Entry Modal Ends Here-->
    ...
    <script>
       window.uniquePageName = "calendar-entries"; // Unique ID for this Blade file needed to tabs
    </script>
    <script>
        window.translations = {
    ...
    <script>
        const TRANSLATIONS = {
            addNewCalendarEntry: @json(__('Add New Calendar Entry')),
            editCalendarEntry: @json(__('Edit Calendar Entry')),
            addCalendarEntry: @json(__('Add Calendar Entry')),
            updateCalendarEntry: @json(__('Update Calendar Entry')),
            deactivateCalendarEntry: @json(__('Cancel Calendar Entry')),
            confirmDeactivate: @json(__('Are you sure you want to cancel calendar entry:')),
    ...
    <!-- calendar entries init -->
   <script src="{{ asset('js/pages/calendar-entries.init.js') }}"></script>
