      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Register<i class="ion-ios-arrow-forward"></i></span></p>
                            ...
                            <div class="col-md-8 offset-md-4">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <p class="mb-0">
                                        ...
                                        <a href="{{ route('login', ['lang' => app()->getLocale()]) }}" class="fw-medium text-primary">
                                            {{ __('Log In') }}
                                            <x-uiw-login class="font-size-20 align-middle ms-1" style="width: 1em; height: 1em;" />
                                        </a>
                                    </p>
                                </div>
                            </div>
